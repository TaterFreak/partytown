/* Partytown 0.8.0-dev1698071230867 - MIT builder.io */
(self => {
    ...
    const getPartytownScript = () => `<script src="${partytownLibUrl("partytown.js?v=0.8.0-dev1698071230867")}"><\/script>`;
                    ...
                    if (!hasInitializedMedia) {
                        (() => {
                            if (!webWorkerCtx.$initWindowMedia$) {
                                ...
                                webWorkerCtx.$importScripts$(partytownLibUrl("partytown-media.js?v=0.8.0-dev1698071230867"));
